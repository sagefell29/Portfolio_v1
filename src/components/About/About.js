...
export const About = () => {
  ...
  return (
    ...
    >
      {/* <hr w='40vw' align='left' color="#ffffff"/> */}
      ...
      <Text m="5" align="left" pl="30" pr="30" fontSize="xl">
        ...
        extensively in various domains of the software development field and am
        always on the lookout for new opportunities to learn and innovate.
      </Text>
      <Text m="5" align="left" pl="30" pr="30" fontSize="xl">
      ...
      <Text m="5" align="left" pl="30" pr="30" fontSize="xl">
        In summary, as a fresher in the software engineering industry, I am{' '}
        <b>
        ...
        collaboratively to solve complex problems. I believe that my passion for
        software engineering and my eagerness to learn and grow make me a{' '}
